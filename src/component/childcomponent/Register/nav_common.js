    ...
    <div className='m-0 p-0 font-Nuinto'>
      <header className='font-nuinto bg-[#173334] font-[400] text-white pl-[10vw] pr-[10vw]'>
        <nav className=' flex justify-evenly items-center -mt-[3vh] h-[17vh] relative '>
            <h1 className=' text-[#febd2f] font-[700] text-3xl'>Auguskart</h1>
            <form className=' shadow-2xl text-black border-slate-400 border-[0.1vw] flex'>
                <button className='p-1'>
                    ...
                    </svg></button> <input type="search" placeholder="Search here.." className=' outline-none bg-[#173334] text-white m-1'/>
            ...
            <p className=' hover:scale-[1.1]' class="contact"><a 
                    href="https://mail.google.com/mail/u/0/#inbox?compose=new">Support 24/7
                    <br/><span className='text-[#febd2f]' >+9179820XXXX</span></a></p>
           
            <button title='login'>
                <Link to="/login" className=' hover:shadow-sm rounded-[50%] hover:shadow-[#febd2f]'  /*style="background-color: #173334;border: none;"*/>
                    <svg className=' hover:scale-[1.1] hover:shadow-xl rounded-[50%]' xmlns="http://www.w3.org/2000/svg" width="1.5vw"
            ...
            <button className=' hover:shadow-sm rounded-[50%] hover:shadow-[#febd2f]'>
                <a href="/wishlist.html">
                    <svg className=' hover:scale-[1.1]' xmlns="http://www.w3.org/2000/svg" width="1.5vw"
        ...
        <div class="itmls" className='relative -top-5 left-[3vw] pb-3'>
            <ul className='flex gap-3 font-semibold'>
                <li className=' hover:text-[#febd2f]'><Link to="/Allcategories">All Categories</Link></li>
                <li className=' hover:text-[#febd2f]'> <Link to="/Vegetable"> Vegetables</Link></li>
                <li className=' hover:text-[#febd2f]'><Link to="/Fruits">Fresh Fruits</Link> </li>
                <li className=' hover:text-[#febd2f]'><Link to="/cookies">Cookies </Link></li>
                <li className=' hover:text-[#febd2f]'><Link to="/">Best Sellers</Link></li>
            </ul>
        </div>
    </header>
    </div>
