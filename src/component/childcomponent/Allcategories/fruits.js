...
export default function vegetable() {
  return (
    <div className=''>
            ...
            <h1 className='text-[#173334] text-4xl font-bold'>Fruits</h1>
            <button className=' bg-[#173334] hover:bg-[#febd2f] hover:text-[#173334] text-white p-1 rounded-sm'><Link to="/Fruits">View all</Link></button>
            </div>
