...
import {Shake} from '../../constantdata/data'
...
export default function actit() {
  return (
    ...
    <div className=' bg-slate-50 text-[#173334]'>
        ...
        <h1 className='ml-[13vw] font-extrabold text-5xl text-[#173334] mt-8 mb-4'>Fruits Juices</h1>
        <p className='w-[50%] ml-[13.5%] font-thin pb-10'>Fruit is a mature ovary and its associated parts. It usually contains seeds, which have developed from the enclosed ovule after fertilization, although development without fertilization, called parthenocarpy, is known, for example, in bananas. Fertilization induces various changes in a flower: the anthers and stigma wither, the petals drop off, and the sepals may be shed or undergo modifications; the ovary enlarges, and the ovules develop into seeds, each containing an embryo plant. The fruit's principal purpose is to protect and disseminate the basis.</p>
    </div>
    <div className=' flex flex-wrap gap-5 ml-[11%] text-[#173334] w-[76%] p-14'>
        {
            Shake.map(item=>
              <div className='w-[20vw] border-[0.1vw] border-solid shadow-xl border-[#1733348b] rounded-md p-2'>
                ...
                <h6 className=' font-semibold text-xl ml-5'>Fruits</h6>
