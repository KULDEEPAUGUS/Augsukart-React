...
import {Vegetable} from '../../constantdata/data'
...
export default function actit() {
  return (
    ...
    <div className=' bg-slate-50 text-[#173334]'>
        <Link to="/" className='flex items-center ml-[13vw] pt-[5vh]'>
            <img src={back} alt="404 Error" className=' w-[4vw]' />
            <h4 className='text-2xl font-normal '>Back to home</h4>
        </Link>
        <h1 className='ml-[13vw] font-extrabold text-5xl text-[#173334] mt-8 mb-4'>Vegetable</h1>
        <p className='w-[50%] ml-[13.5%] font-thin pb-10'>Vegetables are usually classified on the basis of the part of the plant that is used for food. The root vegetables include beets, carrots, radishes, sweet potatoes, and turnips. Stem vegetables include asparagus and kohlrabi. Among the edible tubers, or underground stems, are potatoes. The leaf and leafstalk vegetables include brussels sprouts, cabbage, celery, lettuce, rhubarb, and spinach. Among the bulb, vegetables are garlic, leeks, and onions.</p>
    </div>
    <div className=' flex flex-wrap gap-5 ml-[11%] text-[#173334] w-[76%] p-14'>
        {
            Vegetable.map(item=>
              <div className='w-[20vw] border-[0.1vw] border-solid shadow-xl border-[#1733348b] rounded-md p-2'>
                ...
                <h6 className=' font-semibold text-xl ml-5'>Vegetable</h6>
